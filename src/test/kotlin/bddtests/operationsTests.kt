...
internal class OperationTests /*: DDBuilderIF by Global.context */{
    ...
    fun setVariableTestBDD() = testSession {
        ...
        +"attribute r1: ScalarValues::Boolean = a;"
        initialize()
        ...
        +"attribute r2: ScalarValues::Boolean = a and b;" //
        ...
        +"attribute c: ScalarValues::Boolean = not(b);"
        +"attribute r3: ScalarValues::Boolean = (not(r1) and r2) or (r1 and not(r2));"
        // println("r3 = " + resolveName<ValueFeature>("r3"))

        +"attribute r4: ScalarValues::Boolean = not(r3 and c);"
     ...
     */
    @Test
    fun setVariableTestAADD() = testSession {
            // Create some BDD that depend on variables "a", "b" , "c"
            // set "a" to True or False
            ...
            +"feature r1: ScalarValues::Real = ITE(a, x, y);"
    ...
    @Test
    fun setVariableTestWithComplexBDD() = testSession(catchExceptions = false) {
    ...
    @Test
    fun setVariableTestWithComplexBDDdown() = testSession(loadKerML = false) {
        loadSysMD("""
            package ScalarValues { datatype ScalarValue; datatype Integer :> ScalarValue; datatype Boolean :> ScalarValue; }
     ...
     */
    @Test
    fun setBoolValueTest() = testSession {
        loadSysMD(""" 
    ...
    @Test
    fun leafIntersection1() = testSession {
        loadSysMD(input = """
            feature a: ScalarValues::Boolean;
            feature b: ScalarValues::Boolean(false);
        ...
        val brk2 = 2
        //println(tst.toString())
        //println(tstEval.toString())
        //println("a=" + a.quantity.bdd().toIteString())
        //println("b=" + b.quantity.bdd().toIteString())
        //println("c=" + c.quantity.bdd().toIteString())

        //println("y=" + y.quantity.bdd().toIteString())
        //println(tst.toIteString())
        //println(tstEval.toIteString())
