...
class BuiltInFunctionsTests {
    ...
    @Test
    fun hasAFunctionTest2() = testSession("ScalarValues") {
        loadKerML(
            """
            namespace a;
    ...
    @Test
    fun hasTypeOperationTest() = testSession("ScalarValues") {
        loadKerML(
            input = """
    ...
    @Test
    fun hastypeOperationTest2() = testSession("ScalarValues") {
        loadKerML("""
    ...
    @Test
    fun hasTypeOperationTest3() = testSession("ScalarValues") {
        loadKerML("""
    ...
    @Test
    @Ignore
    fun allOfOperationTest4() = testSession("Ranges") {
    ...
    @Test
    @Ignore //TODO: Fix semantics of anyOf!
