...
class InheritanceTests {
     ...
     */
    @Test
    fun getPropertiesTest2() = testSession("Ranges") {
        loadKerML("""
            type t1 :> Base::Anything { 
     ...
     */
    @Test
    fun varianceTest() = testSession("Ranges") {
        loadKerML("""
     ...
     */
    @Test
    fun findInheritedPropertiesTest4() = testSession("Ranges") {
        loadKerML("""
            package lib {
                type elem :> Base::Anything {
                    feature p: Ranges::RealInRange {:>> range = 1 .. 2;}
     ...
     */
    @Test
    fun getInheritedFeaturesTest5() = testSession("Ranges") {
        loadKerML(""" 
    ...
    @Test
    fun inheritFeatureTest3() = testSession("ScalarValues") {
        loadKerML("""
    ...
    fun inheritedFeatures2() = testSession("ScalarValues") {
        ...
        val baxm = solver.getVariable("B::a::x::multiplicity")
        val caxm = solver.getVariable("C::a::x::multiplicity")
    ...
    // Fixed with 2.0.30.
    @Test fun overrideDerivedPropertyTest() = testSession("ISQ") {
        loadKerML("""           
            type Coin :> Base::Anything {
                feature diameter: ISQ::LengthValue {:>> range = 5..200 [mm];}
                feature circumference: ISQ::LengthValue = diameter*3.141 {:>> range = (* .. *) [mm];} // 15.7 .. 628.2 mm 
            }

            feature oneEuroCoin : Coin { 
                feature diameter: ISQ::LengthValue = 23.25 mm { :>> range = 5..200 [mm]; } 
    ...
    fun overrideDerivedPropertyTest2() = testSession("ScalarValues", "Ranges") {
        loadKerML(
            ...
            type OneEuroCoin :> Coin {
                feature diameter: Ranges::RealInRange  {:>> range = 23;}
     ...
     */
    @Test
    fun inheritanceConstraintTestContradiction() = testSession("Ranges") {
        loadKerML(
            """
            type a specializes Base::Anything {
                feature p: Ranges::RealInRange  {:>> range = 1;} 
            }
            type b specializes a {
                feature p: Ranges::RealInRange {:>> range = 2;}
            }
     ...
     */
    @Test
    fun inheritanceConstraintTestIndirect() = testSession("Ranges") {
        loadKerML(
            """
    ...
    fun realConstraintTest() = testSession("Occurrences", "Ranges") {
        loadKerML("""
            package Test { 
                ...
                class n :> m {feature v: Ranges::RealInRange {:>> range = 6;}}
            }
    ...
    @Test
    fun realConstraintTest2() = testSession("Ranges") {
        loadKerML(
            """
            package Test { 
    ...
    @Test
    fun realConstraintTest3() = testSession("Ranges") {
        loadKerML("""
            package Test {
    ...
    @Test
    fun integerConstraintTest() = testSession("Ranges") {
        loadKerML("""
            package Test { 
    ...
    @Test
    fun integerConstraintTest2() = testSession("Ranges") {
        loadKerML("""
    ...
    fun addVariablesTest() = testSession("ISQ") {
        loadKerML("""
            ...
            type b {
                feature c: Quantities::ScalarQuantityValue [3 .. 4] { :>> range = 1..2 [m]; } // range, unit, cardinality 
