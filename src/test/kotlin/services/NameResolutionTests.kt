...
class NameResolutionTests {
    ...
    fun findSimpleNameTestInGlobal() = testSession {
        addOwnedMember(ClassImplementation(this, declaredName="x"), global)
    ...
    fun findSimpleNameTestInPackage1() = testSession {
        // Setting: p owns x
        val p = addOwnedMember(PackageImplementation(this, declaredName="p"), global)
        val x = addOwnedMember(ClassImplementation(this, declaredName="x"), p)
    ...
    fun findViaImport() = testSession {
        ...
        val a = addOwnedMember(NamespaceImplementation(this, declaredName="a"), pkg)
        val import = addOwnedRelationship(NamespaceImportImplementation(this, importedNamespace = pkg), global)
    ...
    @Test fun findViaImport2() =testSession {
        val test = addOwnedMember(PackageImplementation(this, declaredName = "test"), global)
        val test2 = addOwnedMember(PackageImplementation(this, declaredName = "test2"), global)
        val test1 = addOwnedMember(ClassImplementation(this, declaredName = "test1"), test)
        addOwnedRelationship(NamespaceImportImplementation(this, importingNamespace = global, importedNamespace = test), global)
        addOwnedRelationship(NamespaceImportImplementation(this, importedNamespace = global, importingNamespace = test2), global)
    ...
    fun findPropertyInGlobal() {
        testSession {
            ...
            val id = addOwnedMember(FeatureImplementation(this, declaredName = "test"), global).elementId
    ...
    @Test fun findHasAElementByNameDirectTest() = testSession {
        ...
        val name = addOwnedMember(TypeImplementation(this, declaredName="name"), global) // new class or package in global.
        addOwnedRelationship(SpecializationImplementation(this, specific = name, general = repo.anything!!), name)
        val name2 = addOwnedMember(TypeImplementation(this, declaredName="name2"), name)  // class in name package/element
        addOwnedRelationship(SpecializationImplementation(this, specific = name2, general = repo.anything!!), name2)
    ...
    @Test fun findHasAElementByNameDirectTestNested() = testSession {
        val c0 = addOwnedMember(PackageImplementation(this, declaredName="test"), global)  // new class or package in global.
        val c1 = addOwnedMember(PackageImplementation(this, declaredName="test1"), c0)     // creation of a test1 element in test package/element
        addOwnedMember(ElementImplementation(this, declaredName="test2"), c1)              // creation of a test2 element in test package/element
    ...
    @Test fun findHasAElementByIdDirectTest() = testSession {
        val obj = addOwnedMember(PackageImplementation(this, declaredName = "testID"), global) // new class or package in global.
        addOwnedMember(ElementImplementation(this, declaredName = "name2"), obj)   // creation of a test2 element in test package/element
        addOwnedMember(ElementImplementation(this, declaredName = "test"), global)
        initialize(Runlevel.MODEL)
    ...
    @Test fun findElementTest() = testSession {
        val pkg = addOwnedMember(PackageImplementation(this, declaredName="name"), global) // new class or package in global.
        addOwnedMember(ElementImplementation(this, declaredName="name2"), pkg) // creation of a name2 element in test package/element
    ...
    @Test fun findHasAElementByNameParentTest() = testSession {
        ...
        val name = addOwnedMember(NamespaceImplementation(this, declaredName="name"),  global) // new class or package in global.
        val name2 = addOwnedMember(NamespaceImplementation(this, declaredName="name2"),  name)  // class in name package/element
        val name3 = addOwnedMember(NamespaceImplementation(this, declaredName="name3"), name2)
    ...
    @Test fun findHasAPropertyByNameDirectTest() =  testSession {
        ...
        addOwnedMember(FeatureImplementation(this, declaredName="name2"), name)
    ...
    @Test fun findElementByNameFromImportedPackageTest() = testSession {
        val name = addOwnedMember(NamespaceImplementation(this, declaredName="name"), global)    // new class 'name' of the type anything in global.
        addOwnedRelationship(NamespaceImportImplementation(this, importingNamespace = global, importedNamespace = name), global)
        addOwnedMember(ElementImplementation(this, declaredName="name2"),  name)   // class in class name.
    ...
    @Test fun findPropertyByNameFromImportedPackageTest() = testSession {
        val name = addOwnedMember(NamespaceImplementation(this, declaredName="name"),  global)    // new class or package in global.
        addOwnedRelationship(NamespaceImportImplementation(this, importingNamespace = global, importedNamespace = name), global)
        val feat = addOwnedMember(FeatureImplementation(this, declaredName="name2"), name)            // class in name package/element
        addOwnedRelationship(SpecializationImplementation(this, specific = feat, general = repo.anything!!), feat)
        initialize(Runlevel.MODEL)
