...
class UnitTests {
    ...
    fun setUp() {
        DDBuilder {
            ...
            iddDummy1 = range(-1, 1)
            iddDummy5 = range(-5, 5)
            iddDummy100 = range(-100, 100)
        }
    }


    @Test
    fun defineDomainClasses() = testSession(catchExceptions = false) {
        loadSysMD(
            """
            package Units;
            Units defines
                class Quantity isA ScalarValues::Real;              
                class Voltage isA Quantity. // ([* ..*], [V]). TODO: Add constant initializer for subclasses. 
  
            Units::Quantity hasA feature unit: ScalarValues::String = "*". // ([*]) 
  
            Units::Voltage hasA feature unit: ScalarValues::String = "V". 
            Units hasA feature v: Voltage = 1.0 V. 
        """.trimIndent()
        )
        assertTrue(status.exceptions.isEmpty(), status.exceptions.toString())
        propagate()
        val voltage = global.resolve<Classifier>("Units::Voltage")
        assertNotNull(voltage)
        val v = global.resolveVar("Units::v")
        assertEquals(1.0, v?.vectorQuantity?.getMinAsDouble()!!, 0.00001)
    }
    ...
    fun parseTestAllSI_Units() {
        ...
        assertEquals("m g s A mol cd kg", u.toString())
    }
    ...
    fun toSi_CheckUnits() {
        val u = Unit("N")
        val quantity1 = Quantity(ddDummy1, u)
        assertEquals("m kg / s^2", quantity1.unit.toString())

        val u2 = Unit("1 / N")
        val quantity2 = Quantity(ddDummy1, u2)
        assertEquals("s^2 / m kg", quantity2.unit.toString())
        ...
        assertEquals("m kg / s^2", quantity4.unit.toString())
        ...
        assertEquals("m^2 kg / s^2", quantity5.unit.toString())
    ...
    fun additionTest() {
        ...
        assertEquals("m kg / s^2", result.unit.toString())
    ...
    fun sqrtTest() {
        ...
        assertEquals("s^2 m", result.unit.toString())
    }
    ...
    fun bytesTest() { // with prefix Mi, Gi ..
        ...
        assertEquals("information capacity", quant1.getDimension())
    ...
    fun decibelTest1() {
        ...
        assertEquals("quantity of dimension one", quant1.getDimension())
    ...
    fun quantityMakeCanonicalTest() {
        ...
        assertEquals("m kg / s^2", quant1.unit.toString())
    ...
    @Test
    fun missingUnitsTest() = testSession {
        loadSysMD(
            input = """
            // The units °C, °F and % do not work
                feature test1: ScalarValues::Real[°C];
                feature test2: ScalarValues::Real[°F];
                feature test3: ScalarValues::Real[kg];
                feature percentage: ScalarValues::Real[%].
            """
        )
        initialize()
        propagate()
    ...
    fun differenceTimeTest() {
        ...
        assertEquals("time", quantResult.getDimension())
        assertEquals("s", quantResult.unit.toString())
    }

    @Test
    fun testYear() = testSession {
        loadSysMD("""feature date1: ScalarValues::Real[Year]=Year("2021").""")
        propagate()
    ...
    @Test
    fun testYear2() = testSession {
        loadSysMD(
            """
            feature year: ScalarValues::Real[Year]=Year("2022").
            feature time: ScalarValues::Real[a]=200.0 a.
            feature yearResult: ScalarValues::Real[Year]=year+time."""
        )
    ...
    @Test
    fun testYear3() = testSession {
        loadSysMD(
            """
            feature year: ScalarValues::Real[Year]=Year("2021");
            feature year2: ScalarValues::Real[Year]=Year("2023");
            feature result: ScalarValues::Real[a]=year2-year;"""
        )
    ...
    @Test
    fun testDateTime() = testSession {
        loadSysMD("""feature date1: ScalarValues::Real[DateTime]=DateTime("2021-10-30T13:00:01+02:00");""")
    ...
    @Test
    fun testDateTime2() = testSession {
        loadSysMD("""feature date: ScalarValues::Real[DateTime]=DateTime("2021-10-10T00:00");""")
    ...
    @Test
    fun testDateTimeDiff1() = testSession {
        loadSysMD(
            """
            feature date1: ScalarValues::Real[DateTime]=DateTime("2021-10-30T13:00:01+02:00");
            feature date2: ScalarValues::Real[DateTime]=DateTime("2021-10-30T13:01:01+02:00");
            feature datediff: ScalarValues::Real[s]=date2-date1;"""
        )
    ...
    @Test
    fun testDateTimeDiff2() = testSession {
        loadSysMD(
            """
            feature date1: ScalarValues::Real[DateTime]=DateTime("2021-10-10T03:00:00+02:00");
            feature date2: ScalarValues::Real[DateTime]=DateTime("2021-10-11T03:00:00+02:00");
            feature datediff: ScalarValues::Real[h]=date2-date1;"""
        )
    ...
    @Test
    fun testDateTimeSum() = testSession {
        loadSysMD("""
            feature date: ScalarValues::Real[DateTime]=DateTime("2021-10-10T03:00:00");
            feature time: ScalarValues::Real[a]=1.0 a;
            feature dateResult: ScalarValues::Real[DateTime]=date+time;"""
        )
        propagate()
    ...
    @Test
    fun dateTest() = testSession {
        loadSysMD("""
            feature date: ScalarValues::Real[Date]=Date("2022-10-10");
            feature time: ScalarValues::Real[d]=0.5 d;
            feature dateResult: ScalarValues::Real[Date]=date+time;"""
        )
    ...
    @Test
    fun monthTest() = testSession {
        loadSysMD("""
            feature month: ScalarValues::Real[Month]=Month("2022-10");
            feature time: ScalarValues::Real[d]=20.0 d;
            feature monthResult: ScalarValues::Real[Month]=month+time;"""
        )
        propagate()
    ...
    @Test
    fun monthTest2() = testSession {
        loadSysMD(
            """
            feature month: ScalarValues::Real[Month]=Month("2022-10");
            feature time: ScalarValues::Real[a]=30.0 a;
            feature monthResult: ScalarValues::Real[Month]=month+time;"""
        )
        propagate()
        assertEquals("2022-10", global.resolveVar("month")!!.vectorQuantity.toString())
    ...
    @Test
    fun monthTest3() = testSession {
        loadSysMD("""
            feature month1: ScalarValues::Real[Month]=Month("2021-10");
            feature month2: ScalarValues::Real[Month]=Month("2023-10");
            feature time: ScalarValues::Real[a]=month2-month1;"""
        )
        propagate()
    ...
    @Test
    fun unitsMixed() = testSession {
        loadSysMD("""
                feature percentage: ScalarValues::Real[%] = 10.0 [%];
                feature number: ScalarValues::Real = 1.0;
                feature result: ScalarValues::Real = percentage + number;
                feature ratio: ScalarValues::Real[dB] = 10.0 [dB];
