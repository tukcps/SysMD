...
class QuantityTestDimensions {
    ...
    /** Kinematic Formulars */
    @Test
    fun unitskinematik1() = testSession("ISQ") {
        loadKerML("""
    ...
    @Test
    fun unitskinematik2() = testSession("ISQ") {
        loadKerML("""
    ...
    fun unitsElectricity2() = testSession("ISQ") {
        ...
        solver.propagate() // Strange, destroys an already correct result.
        assertNoIssues()
    ...
    fun kinematicViscosityTest() = testSession("ISQ") {
        ...
        solver.propagate()
        assertNoIssues()
        assertEquals(1.0, global.resolveVar("v")!!.min(), 0.0001)
