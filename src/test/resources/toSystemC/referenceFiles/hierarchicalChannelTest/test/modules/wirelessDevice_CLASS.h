...
#include "interface_wire_class.h"
#include "connector_wire_class.h"
#include "connection_wire_class.h"
...
public:
	...
	//	### Channels  ###
	interface_wire_class interface_wire;
	connector_wire_class connector_wire;
	connection_wire_class connection_wire;
