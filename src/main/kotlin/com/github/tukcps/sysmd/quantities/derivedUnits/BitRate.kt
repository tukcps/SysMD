...
import com.github.tukcps.sysmd.quantities.baseUnits.InformationCapacity
import com.github.tukcps.sysmd.quantities.baseUnits.Time

private var siUnitSet = setOf(InformationCapacity.Bit.copy(), Time.Second.copy(-1))
...
open class BitRate(name: String, symbol: String, prefix: Prefix, convFac: Double, exponent: Int = 1, isLogarithmic: Boolean = false) :
     ...
     */
    object BitsPerSecond : BitRate("bits per second", "b/s", NoPrefix, 1.0)
