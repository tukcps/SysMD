...
open class Resistance(name: String, symbol: String, prefix: Prefix, convFac: Double, exponent: Int = 1, isLogarithmic: Boolean = false) :
    DerivedUnit(name, symbol, prefix, "Resistance", siUnitSet, convFac, exponent, isLogarithmic) {

    /**
     * generate UnitObjects and add them to the UnitList
     */
    object Ohm : Resistance("ohm", "Ω", NoPrefix, 1.0)

    override fun copy(): Resistance {
        return Resistance(name, symbol, prefix, convFac, exponent, isLogarithmic)
    }
}