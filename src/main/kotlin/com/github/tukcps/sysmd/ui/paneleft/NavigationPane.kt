...
fun NavigationPane(
    ...
    val projectListViewModel: ProjectListViewModel = sysMDViewModel.projectListViewModel
    Surface(
        ...
        Column {
            ...
            Box(Modifier.fillMaxHeight().weight(1F)){
                when (selected.value) {
                    0 -> ProjectList(sysMDViewModel.editorTabsViewModel, projectListViewModel, sysMDViewModel::reset)
