...
- know  
    ...
    - the most important strucural elements of SysML v2 and KerML

Note that the tutorial  
- has a focus on the textual representation, and does not introduce the diagrams
- has a focus on the structural elements, and does not introduce much of behavior
- provides integrated examples after many section that you can try directly
...
They are show in the "hasA" tree view left. 
